            ...
            <div className='containerPadding1' >
                ...
                <div className='containerPadding2'>
                    <div className='imageContainer'>
                        ...
                        <img className="profilePic" src="https://i.imgur.com/qKdVLrE.jpg" alt="profileImg" />
                        <img className="profilePic" src="https://i.imgur.com/2syxREY.png" alt="profileImg" />
                        <img className="profilePic" src="https://i.imgur.com/VJK8EOG.jpg" alt="profileImg" />
                    </div>
                    <div className="paragraphStory">
                        <p className='singleParagraphStory '>
                        ...
                        <br /> <br />
                        <h1 className='titleParagraphStory'>
                            -2016 The Grind-
                        </h1>
                        <br /> <br />
